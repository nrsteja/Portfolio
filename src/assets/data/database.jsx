...
export const projectsData = [
    { 
      name: 'Mobile Application', domain: 'UI/UX Development', image: <GroceryGrabber />, level: "BrainHacks Hackathon", conducted: "DSTA", duration: "1 week", topic: 'Grocery Grabber', concepts: [{ name: "React Native", logos: <ReactNative /> }, { name: "OpenAI", logos: <OpenAI /> }, { name: "Figma", logos: <Figma /> }], 
    ...
    { 
      name: 'Hotel Booking', domain: 'Object Oriented Program', image: <HotelBooking />, level: "University Project", conducted: "NTU", duration: "5 weeks", topic: 'Book Quick', concepts: [{ name: "Java", logos: <Java /> }, { name: "OOPS", logos: <OOPS /> }, { name: "Visual Paradigm", logos: <VisualParadigm /> }], 
      description: "Developed a hotel booking software using Java, leveraging OOP concepts to facilitate seamless hotel reservations for customers. Utilized Visual Paradigm to create detailed class diagrams, ensuring efficient implementation of OOP principles and clear understanding of class relationships. The project improved my skills in designing scalable and maintainable software solutions." 
    },
    { 
      name: 'Football Prediction', domain: 'DataSciene Analysis', image: <PremierLeague />, level: "University Project", conducted: "NTU", duration: "6 weeks", topic: 'Premier League', concepts: [{ name: "Linear Regression", logos: <LinearRegressions /> }, { name: "Neural Networks", logos: <NeuralNetwork /> }, { name: "Random Forest", logos: <RandomForest /> }], 
